...
TODO:
1. Решить проблему с пустой неделей (когда для будильника не выбран ни один день недели, в который он должен звонить);
2. Обеспечить срабатывание будильника если компьютер выключен, или находится в спящем режиме;
